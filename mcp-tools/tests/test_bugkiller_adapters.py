"""Tests for deterministic, shell-free Bugkiller command profiles."""
...
from bugkiller.adapters import LanguageKind, detect_repository


class BugkillerAdapterTests(unittest.TestCase):
    def setUp(self) -> None:
