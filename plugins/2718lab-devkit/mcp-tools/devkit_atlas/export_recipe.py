"""Export one verified local Atlas recipe as an atomic promotion bundle."""
...
ROOT = MCP_TOOLS.parent
if str(MCP_TOOLS) not in sys.path:
    sys.path.insert(0, str(MCP_TOOLS))

from devkit_atlas.canonical import canonical_json, thaw_json  # noqa: E402
from devkit_atlas.models import EdgeRelation, NodeKind, RecipeManifest  # noqa: E402
from devkit_atlas.recipes import render_pattern_card  # noqa: E402
from devkit_atlas.security import MAX_RECIPE_BYTES, MAX_TEMPLATE_BYTES  # noqa: E402
from devkit_atlas.service import hydrate_local_manifest  # noqa: E402
from devkit_atlas.store import AtlasStore, StoreConflictError  # noqa: E402


_HASH_PREFIX = "sha256:"
_STAGE_PREFIX = ".atlas-stage-"
_QUARANTINE_PREFIX = ".atlas-quarantine-"
...
def export_recipe(data_root: Path, recipe_id: str, output: Path) -> None:
    ...
    try:
        store = AtlasStore.open_readonly(
            durable_root / "atlas.sqlite3",
            durable_root / "atlas-cas",
        )
    except StoreConflictError as exc:
