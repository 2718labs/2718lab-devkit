...
def test_package_uses_pep440_release_candidate_version() -> None:
    assert getattr(devkit_astrbot, "__version__", None) == "1.0.0rc3"
    assert distribution_version("2718lab-devkit-astrbot") == "1.0.0rc3"
...
def test_cli_reports_semver_release_candidate(
    ...
    assert capsys.readouterr().out == "devkit-astrbot 1.0.0-rc3\n"
