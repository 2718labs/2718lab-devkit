...
- [ ] 🥳 我已阅读并同意遵守该项目的 [贡献指南](https://github.com/yourteam/astrbot_plugin_example/blob/main/CONTRIBUTING.md) / I have read and agree to abide by the [CONTRIBUTING](https://github.com/yourteam/astrbot_plugin_example/blob/main/CONTRIBUTING.md) of this project.

<!-- 团队占位说明:本文件以官方 DBJD-CR/astrbot_plugin_helloworld 模板的 PULL_REQUEST_TEMPLATE.md 为底,
     仅将仓库特定链接替换为 astrbot_plugin_example 占位符。 -->
